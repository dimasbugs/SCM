	...
	<div id="divToPrint" style="clear:both;" >
		...
		<table class="table_invoiceFormat" style="margin-top:50px;">
			<tr>
				...
				<th style="padding-right:30px;"> Kuantitas </th>
				<th> Jumlah </th>
			</tr>
		...
		<br/><br/><br/><br/><br/><br/>
			...
			<p id="footer" style="clear:both;display:none;padding-bottom:20px;text-align:center;">Terima kasih!</p>
		</div>
