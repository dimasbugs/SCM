		...
		if($_SESSION['admin_login'] == true) {
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($username != null && $areacode != null && $phone != null) {
					...
					$requireErr = "* Kode area, Email, Username atau Password tidak valid";
				}
			}
		}
		else {
...
<body>
	...
	<section>
		...
		<li>
			<div class="label-block"> <label for="retailer:phone">No. Telp</label> </div>
			<div class="input-box"> <input type="text" id="retailer:phone" name="txtRetailerPhone" placeholder="No. Telp" value="<?php echo $row_selectRetailerDetails['phone']; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
		...
		<li>
			...
			<div class="input-box"> <textarea type="text" id="retailer:address" name="txtRetailerAddress" placeholder="Alamat"><?php echo $row_selectRetailerDetails['address']; ?></textarea> </div>
		</li>
		<li>
			<input type="submit" value="Update Pelanggan" class="submit_button" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
