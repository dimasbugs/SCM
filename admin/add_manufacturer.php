			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($name != null && $email != null && $username != null && $password != null) {
					...
					if(mysqli_query($con,$query_addManufacturer)) {
						echo "<script> alert(\"Store berhasil ditambahkan\"); </script>";
						header('Refresh:0');
					}
					else {
...
<body>
	...
	<section>
		...
		<li>
			<div class="label-block"> <label for="manufacturer:phone">No. Telepon</label> </div>
			<div class="input-box"> <input type="text" id="manufacturer:phone" name="txtManufacturerPhone" placeholder="No. Telp" value="<?php echo $phoneHolder; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
