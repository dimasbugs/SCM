			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				...
				if($unitName != null) {
					...
					if(mysqli_query($con,$query_UpdateUnit)) {
						echo "<script> alert(\"Update unit berhasil\"); </script>";
						header('Refresh:0;url=view_unit.php');
					}
					else {
						$requireErr = "Update unit gagal";
					}
				}
				else {
...
<body>
	...
	<section>
		...
		<li>
			<input type="submit" value="Update" class="submit_button" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
