...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="retailer:phone" name="txtRetailerPhone" placeholder="No. Telp" value="<?php echo $row_selectRetailer['phone']; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
